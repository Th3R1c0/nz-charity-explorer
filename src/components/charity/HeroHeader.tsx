    ...
    <section className="relative overflow-hidden glass-card md:rounded-2xl p-0 md:p-8 animate-fade-in">
      ...
      <div className="relative flex flex-col gap-4 md:gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex items-start md:items-center gap-4 md:gap-6">
          <div className="h-14 w-14 md:h-20 md:w-20 rounded-xl md:rounded-2xl bg-primary/10 flex items-center justify-center flex-shrink-0 stat-glow">
            <Building2 className="h-7 w-7 md:h-10 md:w-10 text-primary" />
          </div>
          ...
          <div className="space-y-2 min-w-0">
            ...
            {/* Years Operating - separate line on mobile */}
