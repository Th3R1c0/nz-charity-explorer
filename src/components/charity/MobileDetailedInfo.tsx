...
export const MobileDetailedInfo = ({
  ...
  return (
    <section className="glass-card rounded-xl md:hidden">
      <Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-full group">
        <CollapsibleTrigger className={cn(
          "flex items-center justify-between w-full p-4 md:p-6 select-none transition-colors rounded-xl outline-none hover:bg-card/50",
          isOpen ? "rounded-b-none bg-card/50" : "bg-transparent"
        )}>
        ...
        <CollapsibleContent className="animate-accordion-down overflow-hidden">
          <div className="p-4 md:p-6 pt-0 space-y-8 border-t border-border/50">
            {/* Sectors */}
