...
export const FinancialOverviewChart = ({ data }: FinancialOverviewChartProps) => {
  ...
  return (
    <section className="glass-card rounded-2xl p-8 animate-fade-in" style={{ animationDelay: "0.5s" }}>
      <div className="mb-6">
        ...
        <ResponsiveContainer width="100%" height="100%">
          <ComposedChart data={chartData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
            ...
            <YAxis 
              yAxisId="right" 
              orientation="right"
              stroke="hsl(var(--chart-surplus))"
              tick={{ fill: "hsl(var(--chart-surplus))" }}
              tickFormatter={formatCurrency}
            />
            ...
            <Line
              ...
              stroke="hsl(var(--chart-surplus))"
              strokeWidth={3}
              dot={{ fill: "hsl(var(--chart-surplus))", strokeWidth: 2, r: 6 }}
